                ...
                <div className="row align-items-end ">
                  <div className="col col-md-4  align-self-start ">
                    ...
                    <div className="contact-info">
                      <h5>
                        <TfiEmail size="2em" color="" className="m-3" />
                        <a
                          ...
                          className="m-2 p-2"
                        >
                          <RiInstagramFill size="2em" color="instagram" />
                        </a>
                        <a
                        ...
                        <BsTelephoneInboundFill className="m-3" />
                        07533780033
                      </h5>
                    </div>
                  ...
                  <div className="col about-right align-self-end col-lg-8 p-5">
                    ...
                    <p>
                      Previous events have included Drum and Bass King Harry Shotta, Garage Queen
                      and So Solid Members Lisa Maffia and Romeo, DJ Pied Piper and more. We look
                      forward to continuing to provide amazing events and opportunities for
                      Brighton's local talent.
                    </p>
                    <br />
                    <h5>Are you an Artist or DJ</h5>
                    <p>
                      If you struggling to get yourself out there or you simplify do not know where
                      to turn or how to get started then look no further, we are always scouting
                      fresh talent
                    </p>
                    <br />
